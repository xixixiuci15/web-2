...
<form method="POST" action="hasil-form-regis.php" class="container mt-5">
    <fieldset class="border border-dark p-3 rounded" style ="background-color:#FFFFE0;">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nim" name="nim" placeholder="*0110124162" type="text" class="form-control" required="requaired" pattern="[0-9]{10}" title="NIM harus 10 Digit Angka">
      </div>
    </div>
  </div>
  <div class="form-group row">
...
foreach($ar_skill as $nama => $nilai){
    echo "<div class='custom-control custome-checkbox custom-control-inline'>";
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="email" name="email" placeholder="*ciciuci15@gmail.com" type="email" class="form-control" required="required">
      </div>
    </div>
  </div> 
  <div class="form-group row">
