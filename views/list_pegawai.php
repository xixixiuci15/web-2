                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3 text-end">
                                <a href="create_pegawai.php" class="btn btn-success">
                                    ...
                                    <?php foreach ($pegawais as $index => $pegawai): ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="delete_pegawai.php?id=<?= $pegawai['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?')">
