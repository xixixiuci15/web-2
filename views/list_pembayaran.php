...
$sql = "SELECT 
            ...
            GROUP_CONCAT(CONCAT(pr.nama, ' (', dp.jumlah, 'x)') SEPARATOR ', ') AS daftar_produk
        FROM pesanan p
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main class="container-fluid px-4">
                <h1 class="mt-4">Transaksi Keuangan</h1>
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <i class="fas fa-money-bill-wave me-1"></i> Daftar Transaksi
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php foreach ($transaksiList as $t):
                                    $totalBayar = $t['subtotal'] * (1 - ($t['diskon'] / 100));
                                ?>
                                    <tr>
                                        <td><?= $t['id'] ?></td>
                                        <td><?= htmlspecialchars($t['nama_anggota'] ?? 'Tidak diketahui') ?></td>
                                        <td><?= date('d-m-Y', strtotime($t['tanggal'])) ?></td>
                                        <td><?= htmlspecialchars($t['daftar_produk'] ?? '-') ?></td>
                                        ...
                                        <td>
                                            <a href="delete_pesanan.php?id=<?= $t['id'] ?>"
